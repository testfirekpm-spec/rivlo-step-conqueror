...
export const DiamondWarrior = ({ className = "" }: { className?: string; delay?: number }) => (
  <svg
    viewBox="0 0 120 160"
    fill="none"
...
export const HexShield = ({ className = "" }: { className?: string; delay?: number }) => (
  <svg
    viewBox="0 0 140 160"
    fill="none"
    className={`animate-fade-in-up ${className}`}
...
export const TriangleSentinel = ({ className = "" }: { className?: string; delay?: number }) => (
  <svg
    viewBox="0 0 100 140"
    fill="none"
    className={`animate-fade-in-up ${className}`}
...
export const EnergyOrb = ({ className = "", color = "196 80% 55%" }: { className?: string; color?: string; delay?: number }) => (
  <div
    className={`rounded-full animate-fade-in-up ${className}`}
    style={{
